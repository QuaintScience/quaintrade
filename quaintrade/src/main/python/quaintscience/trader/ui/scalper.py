...
class ScalperApp():
    ...
    def ui_on_graph_click(self, location, scrip, chart, *args):
        ...
        if scrip.endswith("CE"):
            col = "green"
        self.selected_scrip.setText(scrip)
    ...
    def init_ui(self) -> None:
        ...
        self.selected_scrip = QLineEdit()
        create_order_layout.addWidget(self.selected_scrip, 0, 0, 1, 4)
        create_order_layout.addWidget(QLabel("Entry"), 1, 0)
        create_order_layout.addWidget(self.entry_trigger, 1, 1)
        create_order_layout.addWidget(QLabel("Lots"), 1, 2)
        create_order_layout.addWidget(self.entry_lots, 1, 3)
        create_order_layout.addWidget(self.entry_order_enabled, 1, 4)

        create_order_layout.addWidget(QLabel("SL"), 2, 0)
        create_order_layout.addWidget(self.sl_trigger, 2, 1)
        create_order_layout.addWidget(self.sl_order_enabled, 2, 4)

        create_order_layout.addWidget(QLabel("Target1"), 3, 0)
        create_order_layout.addWidget(self.target1_order, 3, 1)
        create_order_layout.addWidget(QLabel("Lots"), 3, 2)
        create_order_layout.addWidget(self.target1_lots, 3, 3)
        create_order_layout.addWidget(self.target1_order_enabled, 3, 4)

        create_order_layout.addWidget(QLabel("Target2"), 4, 0)
        create_order_layout.addWidget(self.target2_order, 4, 1)
        create_order_layout.addWidget(QLabel("Lots"), 4, 2)
        create_order_layout.addWidget(self.target2_lots, 4, 3)
        create_order_layout.addWidget(self.target2_order_enabled, 4, 4)

        create_order_layout.addWidget(QLabel("Target3"), 5, 0)
        create_order_layout.addWidget(self.target3_order, 5, 1)
        create_order_layout.addWidget(QLabel("Lots"), 5, 2)
        create_order_layout.addWidget(self.target3_lots, 5, 3)
        create_order_layout.addWidget(self.target3_order_enabled, 5, 4)
        ...
        create_order_layout.addWidget(QLabel("Max Profit"), 6, 0)
        create_order_layout.addWidget(self.anticipated_profit, 6, 1)
        create_order_layout.addWidget(QLabel("Max Loss"), 6, 2)
        create_order_layout.addWidget(self.anticipated_loss, 6, 3)
        ...
        self.refresh_broker_info_button = QPushButton("Refresh Broker Info")
        tol_widget_layout.addWidget(self.place_order_button, 0, 0, 1, 3)
        tol_widget_layout.addWidget(self.refresh_broker_info_button, 0, 3, 1, 3)
        tol_widget_layout.addWidget(QLabel("Filter"), 1, 0)
        tol_widget_layout.addWidget(self.tol_edit, 1, 1)
        tol_widget_layout.addWidget(QLabel("Slip"), 1, 2)
        tol_widget_layout.addWidget(self.slippage_edit, 1, 3)
        tol_widget_layout.addWidget(QLabel("R:R"), 1, 4)
        tol_widget_layout.addWidget(self.rr_edit, 1, 5)
